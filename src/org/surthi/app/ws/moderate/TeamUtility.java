...
public class TeamUtility {
    public TeamUtility() {create_test_store();}
    ...
    public void create_test_store() {
        List<Player> players = Stream.of("Ravi", "Shankar", "Prasad").map(Player::new)
                .collect(Collectors.toList());
        List<Player> players2 = Stream.of("kisore", "kumar", "manmohan").map(Player::new).collect(Collectors.toList());
