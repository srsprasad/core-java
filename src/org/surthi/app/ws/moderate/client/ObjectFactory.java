...
public class ObjectFactory {
  ...
  private final static QName _GetTeam_QNAME =
      new QName("http://moderate.ws.app.surthi.org/", "getTeam");
  private final static QName _GetTeamResponse_QNAME =
      new QName("http://moderate.ws.app.surthi.org/", "getTeamResponse");
  private final static QName _GetTeamsResponse_QNAME =
      new QName("http://moderate.ws.app.surthi.org/", "getTeamsResponse");
  private final static QName _GetTeams_QNAME =
      new QName("http://moderate.ws.app.surthi.org/", "getTeams");
   ...
   * 
   */
  @XmlElementDecl(namespace = "http://moderate.ws.app.surthi.org/", name = "getTeam")
   ...
   * 
   */
  @XmlElementDecl(namespace = "http://moderate.ws.app.surthi.org/", name = "getTeamResponse")
  public JAXBElement<GetTeamResponse> createGetTeamResponse(GetTeamResponse value) {
    return new JAXBElement<GetTeamResponse>(_GetTeamResponse_QNAME, GetTeamResponse.class, null,
        value);
  }
   ...
   * 
   */
  @XmlElementDecl(namespace = "http://moderate.ws.app.surthi.org/", name = "getTeamsResponse")
  public JAXBElement<GetTeamsResponse> createGetTeamsResponse(GetTeamsResponse value) {
    return new JAXBElement<GetTeamsResponse>(_GetTeamsResponse_QNAME, GetTeamsResponse.class, null,
        value);
  }
   ...
   * 
   */
  @XmlElementDecl(namespace = "http://moderate.ws.app.surthi.org/", name = "getTeams")
