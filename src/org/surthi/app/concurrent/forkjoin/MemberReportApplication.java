...
public class MemberReportApplication {
  private static String[][] data = new String[][] {{"Ravi", "07-07-1980", "10-01-2018"},
      {"Vyshu", "03-04-1989", "10-01-2018"}, {"Geetha", "10-04-1976", "10-01-2018"},
      {"Mallika", "08-05-1982", "10-01-2018"}, {"Sidramulu", "16-05-1951", "10-01-2018"},
      {"Balamani", "10-10-1956", "10-01-2018"}, {"Jagadeesh", "10-04-1980", "10-01-2018"}};
...
class MemberWork extends RecursiveAction {
  ...
  protected void compute() {
    if (memberWrappers.size() == 2) {
      ...
      invokeAll(new MemberWork(leftMembers, currentDate),
          new MemberWork(rightMembers, currentDate));
    }
  }
